...
<!-- 	</tr> -->
	<tr>
		...
		<td class="content"><input type=text name=id size=70 maxlength=70 value="<c:out value="${member.getId()}"/>"></td>
	</tr>
	<tr>
		<td class="content"><b>패스워드</b></td>
		<td class="content"><input type=text name=password size=70 maxlength=70 value="<c:out value="${member.getPassword()}"/>"></td>
	</tr>
	<tr>
		<td class="content"><b>이름</b></td>
		<td class="content"><input type=text name=name size=30 maxlength=30 value="<c:out value="${member.getName()}"/>"></td>
	</tr>
	<tr>
		<td class="content"><b>생년월일</b></td>
		<td class="content"><input type=text name=birth size=8 maxlength=8 value="<c:out value="${member.getBirth()}"/>"></td>
	</tr>
	<tr>
		<td class="content"><b>주소</b></td>
		<td class="content"><input type=text name=address size=30 maxlength=30 value="<c:out value="${member.getAddress()}"/>"></td>
	</tr>
	<tr>
		<td class="content"><b>전화번호</b></td>
		<td class="content"><input type=text name=phone size=11 maxlength=11 value="<c:out value="${member.getPhone()}"/>"></td>
	</tr>
</table>
<table width=650>
	<tr>
